module github.com/thk-im/thk-im-group-server
...
require (
	...
	github.com/thk-im/thk-im-msgapi-server v0.0.0-20241107022527-0b70c3ec434c
	github.com/thk-im/thk-im-user-server v0.0.0-20241109060644-de08464a9bfa
